 ...
 */
public class YLListPreference extends YLDialogPreference {
    private CharSequence[] mEntries;
    private CharSequence[] mEntryValues;
    private String mValue;
    private String mSummary;
    /*ivvi begin, add custom blow summary, yangjiajia_2017-02-27*/
    ...
    public YLListPreference(Context context) {
        this(context, null);
    }
        ...
        builder.setSingleChoiceItems(mEntries, mClickedDialogEntryIndex, 
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                         ...
                         */
                        YLListPreference.this.onClick(dialog, DialogInterface.BUTTON_POSITIVE);
                        dialog.dismiss();
                    }
        });
