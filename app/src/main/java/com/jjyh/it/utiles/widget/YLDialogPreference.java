 ...
 */
public class YLDialogPreference extends DialogPreference implements
        DialogInterface.OnClickListener, DialogInterface.OnDismissListener {
    private static final String TAG = "ST.YLDialogPreference";
    ...
    public YLDialogPreference(Context context, AttributeSet attrs, int defStyle) {
    ...
    public YLDialogPreference(Context context, AttributeSet attrs) {
